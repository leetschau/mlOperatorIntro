...
# or `git config init.templateDir ~/Documents/git-template` on repository level

$ python -m venv .env
$ . .env/bin/activate
$ pip install Django ipython ptpython pipdeptree flake8 pep8-naming yapf pynvim  # config Python virtualenv
